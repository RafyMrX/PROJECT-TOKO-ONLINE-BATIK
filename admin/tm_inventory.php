		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Contoh : Kodi, Lembar" name="satuan">
						<p class="help-block">Hanya Masukkan Satuan saja : Kodi atau lembar</p>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<p class="help-block">Harga termasuk harga per satuan</p>
				</div>
			</div>
		</div>
